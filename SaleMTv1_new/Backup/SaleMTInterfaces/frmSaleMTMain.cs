...
namespace SaleMTInterfaces
{
    public partial class frmSaleMTMain : Form
    {
        ...
        {
            bool blReValue = false;
            using (System.Data.Odbc.OdbcConnection cnnSql = new System.Data.Odbc.OdbcConnection("DSN=PostgreSQL"))
            {
                try
                {
                    string strCnnSync = System.Configuration.ConfigurationSettings.AppSettings["ConnectionString"].ToString();
                ...
                {
                    MessageBox.Show(e.ToString(),"", MessageBoxButtons.OKCancel);
                    blReValue = false;
                }
            }
            return blReValue;
