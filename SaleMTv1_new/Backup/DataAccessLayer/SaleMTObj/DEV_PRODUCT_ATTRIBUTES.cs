...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class DEV_PRODUCT_ATTRIBUTES
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<DEV_PRODUCT_ATTRIBUTES>("DEV_PRODUCT_ATTRIBUTES");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "DEV_PRODUCT_ATTRIBUTES",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "DEV_PRODUCT_ATTRIBUTES");
        }
