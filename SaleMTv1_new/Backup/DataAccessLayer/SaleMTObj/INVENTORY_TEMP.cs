...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class INVENTORY_TEMP
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<INVENTORY_TEMP>("INVENTORY_TEMP");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "INVENTORY_TEMP",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "INVENTORY_TEMP");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<INVENTORY_TEMP>("INVENTORY_TEMP", posdb_vnmSqlDAC.newInParam("@INVENTORY_ID", inINVENTORY_ID));
        }
