...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class DEBT_RECEIPT_PAYMENT_VOUNCHER
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<DEBT_RECEIPT_PAYMENT_VOUNCHER>("DEBT_RECEIPT_PAYMENT_VOUNCHER");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "DEBT_RECEIPT_PAYMENT_VOUNCHER",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "DEBT_RECEIPT_PAYMENT_VOUNCHER");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<DEBT_RECEIPT_PAYMENT_VOUNCHER>("DEBT_RECEIPT_PAYMENT_VOUNCHER", posdb_vnmSqlDAC.newInParam("@ID", inID));
        }
