...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class CUSTOMERS_TEMP
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<CUSTOMERS_TEMP>("CUSTOMERS_TEMP");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "CUSTOMERS_TEMP",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "CUSTOMERS_TEMP");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<CUSTOMERS_TEMP>("CUSTOMERS_TEMP", posdb_vnmSqlDAC.newInParam("@CUSTOMER_ID", inCUSTOMER_ID));
        }
