...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class SALES_SPECIAL_DISCOUNT
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<SALES_SPECIAL_DISCOUNT>("SALES_SPECIAL_DISCOUNT");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "SALES_SPECIAL_DISCOUNT",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "SALES_SPECIAL_DISCOUNT");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<SALES_SPECIAL_DISCOUNT>("SALES_SPECIAL_DISCOUNT", posdb_vnmSqlDAC.newInParam("@ID", inID));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        public static List<SALES_SPECIAL_DISCOUNT> ReadByEXPORT_CODE(string inEXPORT_CODE)
        {
            ...
            return posdb_vnmSqlDAC.ReadByParams<SALES_SPECIAL_DISCOUNT>("SALES_SPECIAL_DISCOUNT", posdb_vnmSqlDAC.newInParam("@EXPORT_CODE", parameter));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        public static List<SALES_SPECIAL_DISCOUNT> ReadByDISCOUNT_TERM_CODE(string inDISCOUNT_TERM_CODE)
        {
            ...
            return posdb_vnmSqlDAC.ReadByParams<SALES_SPECIAL_DISCOUNT>("SALES_SPECIAL_DISCOUNT", posdb_vnmSqlDAC.newInParam("@DISCOUNT_TERM_CODE", parameter));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        public static List<SALES_SPECIAL_DISCOUNT> ReadByDISCOUNT_BY(string inDISCOUNT_BY)
        {
            ...
            return posdb_vnmSqlDAC.ReadByParams<SALES_SPECIAL_DISCOUNT>("SALES_SPECIAL_DISCOUNT", posdb_vnmSqlDAC.newInParam("@DISCOUNT_BY", parameter));
        }
