...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class PROMOTIONS
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<PROMOTIONS>("PROMOTIONS");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "PROMOTIONS",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "PROMOTIONS");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<PROMOTIONS>("PROMOTIONS", posdb_vnmSqlDAC.newInParam("@PROMOTION_NO", inPROMOTION_NO));
        }
