...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class SALE_PROMOTION_GIFTS
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<SALE_PROMOTION_GIFTS>("SALE_PROMOTION_GIFTS");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "SALE_PROMOTION_GIFTS",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "SALE_PROMOTION_GIFTS");
        }
