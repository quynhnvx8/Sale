...
{
    public class DEBT_NOTE_FOR_EMPLOYEE : IDataModel
    {
        #region members
        int id;
        string hOST_ID;
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<DEBT_NOTE_FOR_EMPLOYEE>("DEBT_NOTE_FOR_EMPLOYEE");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.ReadById<DEBT_NOTE_FOR_EMPLOYEE>(this, "DEBT_NOTE_FOR_EMPLOYEE");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "DEBT_NOTE_FOR_EMPLOYEE",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "DEBT_NOTE_FOR_EMPLOYEE");
        }
