...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class SALES_PAYMENT_HISTORY_DETAIL
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<SALES_PAYMENT_HISTORY_DETAIL>("SALES_PAYMENT_HISTORY_DETAIL");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "SALES_PAYMENT_HISTORY_DETAIL",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "SALES_PAYMENT_HISTORY_DETAIL");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<SALES_PAYMENT_HISTORY_DETAIL>("SALES_PAYMENT_HISTORY_DETAIL", posdb_vnmSqlDAC.newInParam("@AUTO_ID", inAUTO_ID));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<SALES_PAYMENT_HISTORY_DETAIL>("SALES_PAYMENT_HISTORY_DETAIL", posdb_vnmSqlDAC.newInParam("@CURRENCY_ID", inCURRENCY_ID));
        }
