...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class TRANSFER_SHIFT
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<TRANSFER_SHIFT>("TRANSFER_SHIFT");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "TRANSFER_SHIFT",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "TRANSFER_SHIFT");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<TRANSFER_SHIFT>("TRANSFER_SHIFT", posdb_vnmSqlDAC.newInParam("@TRANSFER_SHIFT_CODE", inTRANSFER_SHIFT_CODE));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<TRANSFER_SHIFT>("TRANSFER_SHIFT", posdb_vnmSqlDAC.newInParam("@TRANSFER_BY", inTRANSFER_BY));
        }
