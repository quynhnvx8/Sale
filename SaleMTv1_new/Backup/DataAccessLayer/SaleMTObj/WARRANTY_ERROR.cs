...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class WARRANTY_ERROR
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<WARRANTY_ERROR>("WARRANTY_ERROR");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "WARRANTY_ERROR",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "WARRANTY_ERROR");
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<WARRANTY_ERROR>("WARRANTY_ERROR", posdb_vnmSqlDAC.newInParam("@WARRANTY_ERROR_CODE", inWARRANTY_ERROR_CODE));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<WARRANTY_ERROR>("WARRANTY_ERROR", posdb_vnmSqlDAC.newInParam("@ID_NO_RECEIPT", inID_NO_RECEIPT));
        }
