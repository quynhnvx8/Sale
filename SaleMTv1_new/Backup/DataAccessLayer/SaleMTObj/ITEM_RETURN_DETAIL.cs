...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class ITEM_RETURN_DETAIL
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<ITEM_RETURN_DETAIL>("ITEM_RETURN_DETAIL");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "ITEM_RETURN_DETAIL",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "ITEM_RETURN_DETAIL");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<ITEM_RETURN_DETAIL>("ITEM_RETURN_DETAIL", posdb_vnmSqlDAC.newInParam("@ITEM_RETURN_DETAIL_CODE", inITEM_RETURN_DETAIL_CODE));
        }
