...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class IN_DM_NHOMVATTU : IDataModel
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<IN_DM_NHOMVATTU>("IN_DM_NHOMVATTU");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.ReadById<IN_DM_NHOMVATTU>(this, "IN_DM_NHOMVATTU");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "IN_DM_NHOMVATTU",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "IN_DM_NHOMVATTU");
        }
