...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class EMPLOYEE_WORKING_TIME : IDataModel
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<EMPLOYEE_WORKING_TIME>("EMPLOYEE_WORKING_TIME");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.ReadById<EMPLOYEE_WORKING_TIME>(this, "EMPLOYEE_WORKING_TIME");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "EMPLOYEE_WORKING_TIME",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "EMPLOYEE_WORKING_TIME");
        }
