...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class DISCOUNT_TERM
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<DISCOUNT_TERM>("DISCOUNT_TERM");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "DISCOUNT_TERM",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "DISCOUNT_TERM");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<DISCOUNT_TERM>("DISCOUNT_TERM", posdb_vnmSqlDAC.newInParam("@DISCOUNT_CODE", inDISCOUNT_CODE));
        }
