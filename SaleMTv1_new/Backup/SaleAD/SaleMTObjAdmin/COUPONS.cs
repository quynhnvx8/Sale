...
public class COUPONS {
	...
	public static List<COUPONS> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<COUPONS>("COUPONS");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "COUPONS");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "COUPONS");
	}
	/// <summary>
	...
	public static List<COUPONS> ReadByCOUPON_NO(string inCOUPON_NO) {
		return rdodb_KTSqlDAC.ReadByParams<COUPONS>("COUPONS", rdodb_KTSqlDAC.newInParam("@COUPON_NO", inCOUPON_NO));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	/// <param name="inVOUCHER_NO"></param>
	public static List<COUPONS> ReadByVOUCHER_NO(string inVOUCHER_NO) {
		object parameter = inVOUCHER_NO ?? string.Empty;
		return rdodb_KTSqlDAC.ReadByParams<COUPONS>("COUPONS", rdodb_KTSqlDAC.newInParam("@VOUCHER_NO", parameter));
	}
