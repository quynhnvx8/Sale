...
public class WAREHOUSE {
	...
	public static List<WAREHOUSE> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<WAREHOUSE>("WAREHOUSE");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "WAREHOUSE");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "WAREHOUSE");
	}
	/// <summary>
	...
	public static List<WAREHOUSE> ReadByWAREHOUSE_CODE(string inWAREHOUSE_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<WAREHOUSE>("WAREHOUSE", rdodb_KTSqlDAC.newInParam("@WAREHOUSE_CODE", inWAREHOUSE_CODE));
	}
