...
public class PROMOTION_DETAIL {
	...
	public static List<PROMOTION_DETAIL> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<PROMOTION_DETAIL>("PROMOTION_DETAIL");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "PROMOTION_DETAIL");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "PROMOTION_DETAIL");
	}
	/// <summary>
	...
	public static List<PROMOTION_DETAIL> ReadByPROMOTION_DETAIL_NO(string inPROMOTION_DETAIL_NO) {
		return rdodb_KTSqlDAC.ReadByParams<PROMOTION_DETAIL>("PROMOTION_DETAIL", rdodb_KTSqlDAC.newInParam("@PROMOTION_DETAIL_NO", inPROMOTION_DETAIL_NO));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	/// <param name="inPROMOTION_NO"></param>
	public static List<PROMOTION_DETAIL> ReadByPROMOTION_NO(string inPROMOTION_NO) {
		return rdodb_KTSqlDAC.ReadByParams<PROMOTION_DETAIL>("PROMOTION_DETAIL", rdodb_KTSqlDAC.newInParam("@PROMOTION_NO", inPROMOTION_NO));
	}
