...
public class EXPORT_PRODUCT_ZONE_DETAIL {
	...
	public static List<EXPORT_PRODUCT_ZONE_DETAIL> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<EXPORT_PRODUCT_ZONE_DETAIL>("EXPORT_PRODUCT_ZONE_DETAIL");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "EXPORT_PRODUCT_ZONE_DETAIL");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "EXPORT_PRODUCT_ZONE_DETAIL");
	}
	/// <summary>
	...
	public static List<EXPORT_PRODUCT_ZONE_DETAIL> ReadByID(Guid inID) {
		return rdodb_KTSqlDAC.ReadByParams<EXPORT_PRODUCT_ZONE_DETAIL>("EXPORT_PRODUCT_ZONE_DETAIL", rdodb_KTSqlDAC.newInParam("@ID", inID));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	...
	public static List<EXPORT_PRODUCT_ZONE_DETAIL> ReadByPRODUCT_ID(string inPRODUCT_ID) {
		return rdodb_KTSqlDAC.ReadByParams<EXPORT_PRODUCT_ZONE_DETAIL>("EXPORT_PRODUCT_ZONE_DETAIL", rdodb_KTSqlDAC.newInParam("@PRODUCT_ID", inPRODUCT_ID));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	...
	public static List<EXPORT_PRODUCT_ZONE_DETAIL> ReadByINVOICE_CODE(string inINVOICE_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<EXPORT_PRODUCT_ZONE_DETAIL>("EXPORT_PRODUCT_ZONE_DETAIL", rdodb_KTSqlDAC.newInParam("@INVOICE_CODE", inINVOICE_CODE));
	}
