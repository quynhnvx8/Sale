...
public class CASH_PAYMENT {
	...
	public static List<CASH_PAYMENT> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<CASH_PAYMENT>("CASH_PAYMENT");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "CASH_PAYMENT");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "CASH_PAYMENT");
	}
	/// <summary>
	...
	public static List<CASH_PAYMENT> ReadByCASH_PAYMENT_ID(string inCASH_PAYMENT_ID) {
		return rdodb_KTSqlDAC.ReadByParams<CASH_PAYMENT>("CASH_PAYMENT", rdodb_KTSqlDAC.newInParam("@CASH_PAYMENT_ID", inCASH_PAYMENT_ID));
	}
