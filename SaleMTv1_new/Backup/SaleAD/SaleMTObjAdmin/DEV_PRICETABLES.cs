...
public class DEV_PRICETABLES {
	...
	public static List<DEV_PRICETABLES> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<DEV_PRICETABLES>("DEV_PRICETABLES");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "DEV_PRICETABLES");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "DEV_PRICETABLES");
	}
	/// <summary>
	...
	public static List<DEV_PRICETABLES> ReadByAUTO_ID(Guid inAUTO_ID) {
		return rdodb_KTSqlDAC.ReadByParams<DEV_PRICETABLES>("DEV_PRICETABLES", rdodb_KTSqlDAC.newInParam("@AUTO_ID", inAUTO_ID));
	}
