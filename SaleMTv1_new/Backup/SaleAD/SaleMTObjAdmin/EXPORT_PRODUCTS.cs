...
public class EXPORT_PRODUCTS {
	...
	public static List<EXPORT_PRODUCTS> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<EXPORT_PRODUCTS>("EXPORT_PRODUCTS");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "EXPORT_PRODUCTS");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "EXPORT_PRODUCTS");
	}
	/// <summary>
	...
	public static List<EXPORT_PRODUCTS> ReadByINVOICE_CODE(string inINVOICE_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<EXPORT_PRODUCTS>("EXPORT_PRODUCTS", rdodb_KTSqlDAC.newInParam("@INVOICE_CODE", inINVOICE_CODE));
	}
