...
public class MASTER_EX_LENSESORDER_INFO {
	...
	public static List<MASTER_EX_LENSESORDER_INFO> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<MASTER_EX_LENSESORDER_INFO>("MASTER_EX_LENSESORDER_INFO");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "MASTER_EX_LENSESORDER_INFO");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "MASTER_EX_LENSESORDER_INFO");
	}
	/// <summary>
	...
	public static List<MASTER_EX_LENSESORDER_INFO> ReadByID(Guid inID) {
		return rdodb_KTSqlDAC.ReadByParams<MASTER_EX_LENSESORDER_INFO>("MASTER_EX_LENSESORDER_INFO", rdodb_KTSqlDAC.newInParam("@ID", inID));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	/// <param name="inLENSESORDER_CODE"></param>
	public static List<MASTER_EX_LENSESORDER_INFO> ReadByLENSESORDER_CODE(string inLENSESORDER_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<MASTER_EX_LENSESORDER_INFO>("MASTER_EX_LENSESORDER_INFO", rdodb_KTSqlDAC.newInParam("@LENSESORDER_CODE", inLENSESORDER_CODE));
	}
