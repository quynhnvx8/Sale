...
public class MASTER_WARRANTY_ERROR {
	...
	public static List<MASTER_WARRANTY_ERROR> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<MASTER_WARRANTY_ERROR>("MASTER_WARRANTY_ERROR");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "MASTER_WARRANTY_ERROR");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "MASTER_WARRANTY_ERROR");
	}
	/// <summary>
	...
	public static List<MASTER_WARRANTY_ERROR> ReadByWARRANTY_ERROR_CODE(string inWARRANTY_ERROR_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<MASTER_WARRANTY_ERROR>("MASTER_WARRANTY_ERROR", rdodb_KTSqlDAC.newInParam("@WARRANTY_ERROR_CODE", inWARRANTY_ERROR_CODE));
	}
