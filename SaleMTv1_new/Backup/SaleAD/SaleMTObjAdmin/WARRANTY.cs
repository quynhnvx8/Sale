...
public class WARRANTY {
	...
	public static List<WARRANTY> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<WARRANTY>("WARRANTY");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "WARRANTY");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "WARRANTY");
	}
	/// <summary>
	...
	public static List<WARRANTY> ReadByID_NO_RECEIPT(string inID_NO_RECEIPT) {
		return rdodb_KTSqlDAC.ReadByParams<WARRANTY>("WARRANTY", rdodb_KTSqlDAC.newInParam("@ID_NO_RECEIPT", inID_NO_RECEIPT));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	...
	public static List<WARRANTY> ReadByEMPLOYEE_ID(string inEMPLOYEE_ID) {
		...
		return rdodb_KTSqlDAC.ReadByParams<WARRANTY>("WARRANTY", rdodb_KTSqlDAC.newInParam("@EMPLOYEE_ID", parameter));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	...
	public static List<WARRANTY> ReadByTRANSFER_SHIFT_CODE(string inTRANSFER_SHIFT_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<WARRANTY>("WARRANTY", rdodb_KTSqlDAC.newInParam("@TRANSFER_SHIFT_CODE", inTRANSFER_SHIFT_CODE));
	}
