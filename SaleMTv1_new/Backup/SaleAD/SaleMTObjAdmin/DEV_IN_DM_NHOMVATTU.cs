...
public class DEV_IN_DM_NHOMVATTU : IDataModel {
	...
	public static List<DEV_IN_DM_NHOMVATTU> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<DEV_IN_DM_NHOMVATTU>("DEV_IN_DM_NHOMVATTU");
	}
	/// <summary>
	///Populates item from database by its id.
	/// </summary>
	private void populate() {
		rdodb_KTSqlDAC.ReadById<DEV_IN_DM_NHOMVATTU>(this, "DEV_IN_DM_NHOMVATTU");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "DEV_IN_DM_NHOMVATTU");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "DEV_IN_DM_NHOMVATTU");
	}
