...
public class EXCHANGE_RATE : IDataModel {
	...
	public static List<EXCHANGE_RATE> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<EXCHANGE_RATE>("EXCHANGE_RATE");
	}
	/// <summary>
	///Populates item from database by its id.
	/// </summary>
	private void populate() {
		rdodb_KTSqlDAC.ReadById<EXCHANGE_RATE>(this, "EXCHANGE_RATE");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "EXCHANGE_RATE");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "EXCHANGE_RATE");
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	/// <param name="inCURRENCY_ID"></param>
	public static List<EXCHANGE_RATE> ReadByCURRENCY_ID(string inCURRENCY_ID) {
		return rdodb_KTSqlDAC.ReadByParams<EXCHANGE_RATE>("EXCHANGE_RATE", rdodb_KTSqlDAC.newInParam("@CURRENCY_ID", inCURRENCY_ID));
	}
