...
public class CUSTOMER_CARD_RESET {
	...
	public static List<CUSTOMER_CARD_RESET> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<CUSTOMER_CARD_RESET>("CUSTOMER_CARD_RESET");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "CUSTOMER_CARD_RESET");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "CUSTOMER_CARD_RESET");
	}
	/// <summary>
	...
	public static List<CUSTOMER_CARD_RESET> ReadByID(Guid inID) {
		return rdodb_KTSqlDAC.ReadByParams<CUSTOMER_CARD_RESET>("CUSTOMER_CARD_RESET", rdodb_KTSqlDAC.newInParam("@ID", inID));
	}
	/// <summary>
	///Read by Unique Constraint
	/// </summary>
	...
	public static List<CUSTOMER_CARD_RESET> ReadByrowguid(Guid inrowguid) {
		return rdodb_KTSqlDAC.ReadByParams<CUSTOMER_CARD_RESET>("CUSTOMER_CARD_RESET", rdodb_KTSqlDAC.newInParam("@rowguid", inrowguid));
	}
