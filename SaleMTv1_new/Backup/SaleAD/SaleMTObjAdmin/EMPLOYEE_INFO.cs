...
public class EMPLOYEE_INFO {
	...
	public static List<EMPLOYEE_INFO> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<EMPLOYEE_INFO>("EMPLOYEE_INFO");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "EMPLOYEE_INFO");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "EMPLOYEE_INFO");
	}
	/// <summary>
	...
	public static List<EMPLOYEE_INFO> ReadByEMPLOYEE_ID(string inEMPLOYEE_ID) {
		return rdodb_KTSqlDAC.ReadByParams<EMPLOYEE_INFO>("EMPLOYEE_INFO", rdodb_KTSqlDAC.newInParam("@EMPLOYEE_ID", inEMPLOYEE_ID));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	/// <param name="inPOSITION_CODE"></param>
	public static List<EMPLOYEE_INFO> ReadByPOSITION_CODE(string inPOSITION_CODE) {
		object parameter = inPOSITION_CODE ?? string.Empty;
		return rdodb_KTSqlDAC.ReadByParams<EMPLOYEE_INFO>("EMPLOYEE_INFO", rdodb_KTSqlDAC.newInParam("@POSITION_CODE", parameter));
	}
