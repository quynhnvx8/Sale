...
public class TEMP_01 
{
	...
	public static List<TEMP_01> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<TEMP_01>("TEMP_01");
	}
	/// <summary>
	///Populates item from database by its id.
	/// </summary>
	private void populate() {
		rdodb_KTSqlDAC.ReadById<TEMP_01>(this, "TEMP_01");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "TEMP_01");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "TEMP_01");
	}
