...
public class MASTER_EX_EXAMEYE {
	...
	public static List<MASTER_EX_EXAMEYE> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<MASTER_EX_EXAMEYE>("MASTER_EX_EXAMEYE");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "MASTER_EX_EXAMEYE");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "MASTER_EX_EXAMEYE");
	}
	/// <summary>
	...
	public static List<MASTER_EX_EXAMEYE> ReadByExamEye_Code(string inExamEye_Code) {
		return rdodb_KTSqlDAC.ReadByParams<MASTER_EX_EXAMEYE>("MASTER_EX_EXAMEYE", rdodb_KTSqlDAC.newInParam("@ExamEye_Code", inExamEye_Code));
	}
