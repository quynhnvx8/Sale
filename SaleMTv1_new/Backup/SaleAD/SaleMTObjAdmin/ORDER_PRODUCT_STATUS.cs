...
public class ORDER_PRODUCT_STATUS {
	...
	public static List<ORDER_PRODUCT_STATUS> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<ORDER_PRODUCT_STATUS>("ORDER_PRODUCT_STATUS");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "ORDER_PRODUCT_STATUS");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "ORDER_PRODUCT_STATUS");
	}
	/// <summary>
	...
	public static List<ORDER_PRODUCT_STATUS> ReadByAUTO_ID(Guid inAUTO_ID) {
		return rdodb_KTSqlDAC.ReadByParams<ORDER_PRODUCT_STATUS>("ORDER_PRODUCT_STATUS", rdodb_KTSqlDAC.newInParam("@AUTO_ID", inAUTO_ID));
	}
