...
public class USER_CHAT {
	...
	public static List<USER_CHAT> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<USER_CHAT>("USER_CHAT");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "USER_CHAT");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "USER_CHAT");
	}
	/// <summary>
	...
	public static List<USER_CHAT> ReadByID(Guid inID) {
		return rdodb_KTSqlDAC.ReadByParams<USER_CHAT>("USER_CHAT", rdodb_KTSqlDAC.newInParam("@ID", inID));
	}
