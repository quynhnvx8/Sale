...
public class DEBT_VOUNCHER {
	...
	public static List<DEBT_VOUNCHER> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<DEBT_VOUNCHER>("DEBT_VOUNCHER");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "DEBT_VOUNCHER");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "DEBT_VOUNCHER");
	}
	/// <summary>
	...
	public static List<DEBT_VOUNCHER> ReadByID(Guid inID) {
		return rdodb_KTSqlDAC.ReadByParams<DEBT_VOUNCHER>("DEBT_VOUNCHER", rdodb_KTSqlDAC.newInParam("@ID", inID));
	}
