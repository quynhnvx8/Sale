...
public class SALE_ORDERS {
	...
	public static List<SALE_ORDERS> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<SALE_ORDERS>("SALE_ORDERS");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "SALE_ORDERS");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "SALE_ORDERS");
	}
	/// <summary>
	...
	public static List<SALE_ORDERS> ReadByID(Guid inID) {
		return rdodb_KTSqlDAC.ReadByParams<SALE_ORDERS>("SALE_ORDERS", rdodb_KTSqlDAC.newInParam("@ID", inID));
	}
