...
public class MESSAGE_STORES {
	...
	public static List<MESSAGE_STORES> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<MESSAGE_STORES>("MESSAGE_STORES");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "MESSAGE_STORES");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "MESSAGE_STORES");
	}
	/// <summary>
	...
	public static List<MESSAGE_STORES> ReadByID(Guid inID) {
		return rdodb_KTSqlDAC.ReadByParams<MESSAGE_STORES>("MESSAGE_STORES", rdodb_KTSqlDAC.newInParam("@ID", inID));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	/// <param name="inMESSAGE_ID"></param>
	public static List<MESSAGE_STORES> ReadByMESSAGE_ID(string inMESSAGE_ID) {
		return rdodb_KTSqlDAC.ReadByParams<MESSAGE_STORES>("MESSAGE_STORES", rdodb_KTSqlDAC.newInParam("@MESSAGE_ID", inMESSAGE_ID));
	}
