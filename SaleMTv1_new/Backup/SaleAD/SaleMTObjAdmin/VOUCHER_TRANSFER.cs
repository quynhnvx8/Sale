...
public class VOUCHER_TRANSFER {
	...
	public static List<VOUCHER_TRANSFER> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<VOUCHER_TRANSFER>("VOUCHER_TRANSFER");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "VOUCHER_TRANSFER");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "VOUCHER_TRANSFER");
	}
	/// <summary>
	...
	public static List<VOUCHER_TRANSFER> ReadByEXPORT_CODE(string inEXPORT_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<VOUCHER_TRANSFER>("VOUCHER_TRANSFER", rdodb_KTSqlDAC.newInParam("@EXPORT_CODE", inEXPORT_CODE));
	}
