...
public class DEPT_HISTORY {
	...
	public static List<DEPT_HISTORY> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<DEPT_HISTORY>("DEPT_HISTORY");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "DEPT_HISTORY");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "DEPT_HISTORY");
	}
	/// <summary>
	...
	public static List<DEPT_HISTORY> ReadByAUTO_ID(decimal inAUTO_ID) {
		return rdodb_KTSqlDAC.ReadByParams<DEPT_HISTORY>("DEPT_HISTORY", rdodb_KTSqlDAC.newInParam("@AUTO_ID", inAUTO_ID));
	}
