...
public class MASTER_EX_LENSESORDER {
	...
	public static List<MASTER_EX_LENSESORDER> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<MASTER_EX_LENSESORDER>("MASTER_EX_LENSESORDER");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "MASTER_EX_LENSESORDER");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "MASTER_EX_LENSESORDER");
	}
	/// <summary>
	...
	public static List<MASTER_EX_LENSESORDER> ReadByLENSESORDER_CODE(string inLENSESORDER_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<MASTER_EX_LENSESORDER>("MASTER_EX_LENSESORDER", rdodb_KTSqlDAC.newInParam("@LENSESORDER_CODE", inLENSESORDER_CODE));
	}
