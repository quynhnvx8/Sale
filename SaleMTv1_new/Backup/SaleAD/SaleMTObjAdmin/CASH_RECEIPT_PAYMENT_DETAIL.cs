...
public class CASH_RECEIPT_PAYMENT_DETAIL {
	...
	public static List<CASH_RECEIPT_PAYMENT_DETAIL> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<CASH_RECEIPT_PAYMENT_DETAIL>("CASH_RECEIPT_PAYMENT_DETAIL");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "CASH_RECEIPT_PAYMENT_DETAIL");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "CASH_RECEIPT_PAYMENT_DETAIL");
	}
	/// <summary>
	...
	public static List<CASH_RECEIPT_PAYMENT_DETAIL> ReadByRECEIPT_PAYMENT_DETAIL_ID(Guid inRECEIPT_PAYMENT_DETAIL_ID) {
		return rdodb_KTSqlDAC.ReadByParams<CASH_RECEIPT_PAYMENT_DETAIL>("CASH_RECEIPT_PAYMENT_DETAIL", rdodb_KTSqlDAC.newInParam("@RECEIPT_PAYMENT_DETAIL_ID", inRECEIPT_PAYMENT_DETAIL_ID));
	}
