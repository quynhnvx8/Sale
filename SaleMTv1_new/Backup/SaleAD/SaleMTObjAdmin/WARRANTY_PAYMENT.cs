...
public class WARRANTY_PAYMENT {
	...
	public static List<WARRANTY_PAYMENT> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<WARRANTY_PAYMENT>("WARRANTY_PAYMENT");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "WARRANTY_PAYMENT");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "WARRANTY_PAYMENT");
	}
	/// <summary>
	...
	public static List<WARRANTY_PAYMENT> ReadByID(string inID) {
		return rdodb_KTSqlDAC.ReadByParams<WARRANTY_PAYMENT>("WARRANTY_PAYMENT", rdodb_KTSqlDAC.newInParam("@ID", inID));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	...
	public static List<WARRANTY_PAYMENT> ReadByID_NO_RECEIPT(string inID_NO_RECEIPT) {
		...
		return rdodb_KTSqlDAC.ReadByParams<WARRANTY_PAYMENT>("WARRANTY_PAYMENT", rdodb_KTSqlDAC.newInParam("@ID_NO_RECEIPT", parameter));
	}
