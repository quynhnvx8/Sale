...
public class MASTER_DATA {
	...
	public static List<MASTER_DATA> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<MASTER_DATA>("MASTER_DATA");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "MASTER_DATA");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "MASTER_DATA");
	}
	/// <summary>
	...
	public static List<MASTER_DATA> ReadByMASTER_CODE(string inMASTER_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<MASTER_DATA>("MASTER_DATA", rdodb_KTSqlDAC.newInParam("@MASTER_CODE", inMASTER_CODE));
	}
