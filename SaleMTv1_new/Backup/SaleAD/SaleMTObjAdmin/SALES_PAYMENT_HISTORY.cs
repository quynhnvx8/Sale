...
public class SALES_PAYMENT_HISTORY {
	...
	public static List<SALES_PAYMENT_HISTORY> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<SALES_PAYMENT_HISTORY>("SALES_PAYMENT_HISTORY");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "SALES_PAYMENT_HISTORY");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "SALES_PAYMENT_HISTORY");
	}
	/// <summary>
	...
	public static List<SALES_PAYMENT_HISTORY> ReadByAUTO_ID(Guid inAUTO_ID) {
		return rdodb_KTSqlDAC.ReadByParams<SALES_PAYMENT_HISTORY>("SALES_PAYMENT_HISTORY", rdodb_KTSqlDAC.newInParam("@AUTO_ID", inAUTO_ID));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	...
	public static List<SALES_PAYMENT_HISTORY> ReadByDELIVERY_METHOD(string inDELIVERY_METHOD) {
		...
		return rdodb_KTSqlDAC.ReadByParams<SALES_PAYMENT_HISTORY>("SALES_PAYMENT_HISTORY", rdodb_KTSqlDAC.newInParam("@DELIVERY_METHOD", parameter));
	}
