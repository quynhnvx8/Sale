...
public class EXPORT_DETAIL {
	...
	public static List<EXPORT_DETAIL> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<EXPORT_DETAIL>("EXPORT_DETAIL");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "EXPORT_DETAIL");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "EXPORT_DETAIL");
	}
	/// <summary>
	...
	public static List<EXPORT_DETAIL> ReadByID(Guid inID) {
		return rdodb_KTSqlDAC.ReadByParams<EXPORT_DETAIL>("EXPORT_DETAIL", rdodb_KTSqlDAC.newInParam("@ID", inID));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	/// <param name="inPRODUCT_ID"></param>
	public static List<EXPORT_DETAIL> ReadByPRODUCT_ID(string inPRODUCT_ID) {
		return rdodb_KTSqlDAC.ReadByParams<EXPORT_DETAIL>("EXPORT_DETAIL", rdodb_KTSqlDAC.newInParam("@PRODUCT_ID", inPRODUCT_ID));
	}
