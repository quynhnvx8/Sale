...
public class MAIL_TEMPLATE {
	...
	public static List<MAIL_TEMPLATE> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<MAIL_TEMPLATE>("MAIL_TEMPLATE");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "MAIL_TEMPLATE");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "MAIL_TEMPLATE");
	}
	/// <summary>
	...
	public static List<MAIL_TEMPLATE> ReadBymTEMPLATE_ID(string inmTEMPLATE_ID) {
		return rdodb_KTSqlDAC.ReadByParams<MAIL_TEMPLATE>("MAIL_TEMPLATE", rdodb_KTSqlDAC.newInParam("@mTEMPLATE_ID", inmTEMPLATE_ID));
	}
