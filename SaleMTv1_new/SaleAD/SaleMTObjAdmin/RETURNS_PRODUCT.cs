...
public class RETURNS_PRODUCT {
	...
	public static List<RETURNS_PRODUCT> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<RETURNS_PRODUCT>("RETURNS_PRODUCT");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "RETURNS_PRODUCT");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "RETURNS_PRODUCT");
	}
	/// <summary>
	...
	public static List<RETURNS_PRODUCT> ReadByRETURNS_ID(string inRETURNS_ID) {
		return rdodb_KTSqlDAC.ReadByParams<RETURNS_PRODUCT>("RETURNS_PRODUCT", rdodb_KTSqlDAC.newInParam("@RETURNS_ID", inRETURNS_ID));
	}
