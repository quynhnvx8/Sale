...
public class COMPANY_INFO {
	...
	public static List<COMPANY_INFO> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<COMPANY_INFO>("COMPANY_INFO");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "COMPANY_INFO");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "COMPANY_INFO");
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	/// <param name="inCOUNTRY_CODE"></param>
	public static List<COMPANY_INFO> ReadByCOUNTRY_CODE(string inCOUNTRY_CODE) {
		object parameter = inCOUNTRY_CODE ?? string.Empty;
		return rdodb_KTSqlDAC.ReadByParams<COMPANY_INFO>("COMPANY_INFO", rdodb_KTSqlDAC.newInParam("@COUNTRY_CODE", parameter));
	}
