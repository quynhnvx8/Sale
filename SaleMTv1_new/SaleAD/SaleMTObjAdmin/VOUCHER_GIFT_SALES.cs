...
public class VOUCHER_GIFT_SALES {
	...
	public static List<VOUCHER_GIFT_SALES> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<VOUCHER_GIFT_SALES>("VOUCHER_GIFT_SALES");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "VOUCHER_GIFT_SALES");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "VOUCHER_GIFT_SALES");
	}
	/// <summary>
	...
	public static List<VOUCHER_GIFT_SALES> ReadByINVOICE_ID(string inINVOICE_ID) {
		return rdodb_KTSqlDAC.ReadByParams<VOUCHER_GIFT_SALES>("VOUCHER_GIFT_SALES", rdodb_KTSqlDAC.newInParam("@INVOICE_ID", inINVOICE_ID));
	}
