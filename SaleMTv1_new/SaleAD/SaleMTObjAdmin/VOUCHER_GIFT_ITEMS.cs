...
public class VOUCHER_GIFT_ITEMS {
	...
	public static List<VOUCHER_GIFT_ITEMS> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<VOUCHER_GIFT_ITEMS>("VOUCHER_GIFT_ITEMS");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "VOUCHER_GIFT_ITEMS");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "VOUCHER_GIFT_ITEMS");
	}
	/// <summary>
	...
	public static List<VOUCHER_GIFT_ITEMS> ReadByITEM_NO(string inITEM_NO) {
		return rdodb_KTSqlDAC.ReadByParams<VOUCHER_GIFT_ITEMS>("VOUCHER_GIFT_ITEMS", rdodb_KTSqlDAC.newInParam("@ITEM_NO", inITEM_NO));
	}
	/// <summary>
	///Read By Foreign Key
	/// </summary>
	/// <param name="inVOUCHER_GIFT_NO"></param>
	public static List<VOUCHER_GIFT_ITEMS> ReadByVOUCHER_GIFT_NO(string inVOUCHER_GIFT_NO) {
		object parameter = inVOUCHER_GIFT_NO ?? string.Empty;
		return rdodb_KTSqlDAC.ReadByParams<VOUCHER_GIFT_ITEMS>("VOUCHER_GIFT_ITEMS", rdodb_KTSqlDAC.newInParam("@VOUCHER_GIFT_NO", parameter));
	}
