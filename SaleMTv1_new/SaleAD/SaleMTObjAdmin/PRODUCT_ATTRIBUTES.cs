...
public class PRODUCT_ATTRIBUTES {
	...
	public static List<PRODUCT_ATTRIBUTES> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<PRODUCT_ATTRIBUTES>("PRODUCT_ATTRIBUTES");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "PRODUCT_ATTRIBUTES");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "PRODUCT_ATTRIBUTES");
	}
