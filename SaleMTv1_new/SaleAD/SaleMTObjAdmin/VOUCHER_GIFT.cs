...
public class VOUCHER_GIFT {
	...
	public static List<VOUCHER_GIFT> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<VOUCHER_GIFT>("VOUCHER_GIFT");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "VOUCHER_GIFT");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "VOUCHER_GIFT");
	}
	/// <summary>
	...
	public static List<VOUCHER_GIFT> ReadByVOUCHER_GIFT_NO(string inVOUCHER_GIFT_NO) {
		return rdodb_KTSqlDAC.ReadByParams<VOUCHER_GIFT>("VOUCHER_GIFT", rdodb_KTSqlDAC.newInParam("@VOUCHER_GIFT_NO", inVOUCHER_GIFT_NO));
	}
