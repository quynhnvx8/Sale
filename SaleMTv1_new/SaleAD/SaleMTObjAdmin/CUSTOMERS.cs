...
public class CUSTOMERS {
	...
	[SqlColumn("TOTAL_BILL_AMOUNT", SqlDbType.Float)]
	...
	public static List<CUSTOMERS> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<CUSTOMERS>("CUSTOMERS");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "CUSTOMERS");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "CUSTOMERS");
	}
	/// <summary>
	...
	public static List<CUSTOMERS> ReadByCUSTOMER_ID(string inCUSTOMER_ID) {
		return rdodb_KTSqlDAC.ReadByParams<CUSTOMERS>("CUSTOMERS", rdodb_KTSqlDAC.newInParam("@CUSTOMER_ID", inCUSTOMER_ID));
	}
