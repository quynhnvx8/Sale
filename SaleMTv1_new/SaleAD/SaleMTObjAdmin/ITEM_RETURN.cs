...
public class ITEM_RETURN {
	...
	public static List<ITEM_RETURN> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<ITEM_RETURN>("ITEM_RETURN");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "ITEM_RETURN");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "ITEM_RETURN");
	}
	/// <summary>
	...
	public static List<ITEM_RETURN> ReadByRETURN_CODE(string inRETURN_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<ITEM_RETURN>("ITEM_RETURN", rdodb_KTSqlDAC.newInParam("@RETURN_CODE", inRETURN_CODE));
	}
