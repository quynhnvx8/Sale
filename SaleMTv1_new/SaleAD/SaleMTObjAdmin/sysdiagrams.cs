...
public class sysdiagrams : IDataModel {
	...
	public static List<sysdiagrams> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<sysdiagrams>("sysdiagrams");
	}
	/// <summary>
	///Populates item from database by its id.
	/// </summary>
	private void populate() {
		rdodb_KTSqlDAC.ReadById<sysdiagrams>(this, "sysdiagrams");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "sysdiagrams");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "sysdiagrams");
	}
