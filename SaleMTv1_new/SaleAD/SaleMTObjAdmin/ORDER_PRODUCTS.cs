...
public class ORDER_PRODUCTS {
	...
	public static List<ORDER_PRODUCTS> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<ORDER_PRODUCTS>("ORDER_PRODUCTS");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "ORDER_PRODUCTS");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "ORDER_PRODUCTS");
	}
	/// <summary>
	...
	public static List<ORDER_PRODUCTS> ReadByORDER_CODE(string inORDER_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<ORDER_PRODUCTS>("ORDER_PRODUCTS", rdodb_KTSqlDAC.newInParam("@ORDER_CODE", inORDER_CODE));
	}
