...
public class DEPT {
	...
	public static List<DEPT> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<DEPT>("DEPT");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save(bool isNew) {
		rdodb_KTSqlDAC.Save(this, "DEPT",isNew);
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "DEPT");
	}
	/// <summary>
	...
	public static List<DEPT> ReadByDEPT_CODE(int inDEPT_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<DEPT>("DEPT", rdodb_KTSqlDAC.newInParam("@DEPT_CODE", inDEPT_CODE));
	}
