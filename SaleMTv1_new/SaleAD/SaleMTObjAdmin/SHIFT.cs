...
public class SHIFT {
	...
	public static List<SHIFT> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<SHIFT>("SHIFT");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "SHIFT");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "SHIFT");
	}
	/// <summary>
	...
	public static List<SHIFT> ReadBySHIFT_CODE(string inSHIFT_CODE) {
		return rdodb_KTSqlDAC.ReadByParams<SHIFT>("SHIFT", rdodb_KTSqlDAC.newInParam("@SHIFT_CODE", inSHIFT_CODE));
	}
