...
public class DEV_IN_DM_SEG_NHOMVT : IDataModel {
	...
	public static List<DEV_IN_DM_SEG_NHOMVT> ReadAll() {
		return rdodb_KTSqlDAC.ReadAll<DEV_IN_DM_SEG_NHOMVT>("DEV_IN_DM_SEG_NHOMVT");
	}
	/// <summary>
	///Populates item from database by its id.
	/// </summary>
	private void populate() {
		rdodb_KTSqlDAC.ReadById<DEV_IN_DM_SEG_NHOMVT>(this, "DEV_IN_DM_SEG_NHOMVT");
	}
	/// <summary>
	///Saves item to database.
	/// </summary>
	public void Save() {
		rdodb_KTSqlDAC.Save(this, "DEV_IN_DM_SEG_NHOMVT");
	}
	/// <summary>
	///Deletes item from database.
	/// </summary>
	public void Delete() {
		rdodb_KTSqlDAC.Delete(this, "DEV_IN_DM_SEG_NHOMVT");
	}
