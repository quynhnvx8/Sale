...
namespace SaleMTBusiness.InventoryManagement
{
    public class Import
    {
        ...
        #region Constant
        private const string IMPORT_PRODUCT_REPORT_PATH = "\\Reports\\rptImportProducts.rpt";
        #endregion
        ...
        #region Method
        /// <summary>
        /// Người tạo Thanhdh – 30/09/2013 : Lấy danh sách nhập hàng
        /// </summary>
        ...
        /// <summary>
        /// Người tạo Thanhdh – 30/09/2013 : Lấy thông tin nhập hàng
        /// </summary>
        ...
        /// <summary>
        /// Người tạo Thanhdh – 30/09/2013 : Lấy chi tiết hóa đơn nhập hàng
        /// </summary>
        ...
        /// <summary>
        /// Người tạo Thanhdh – 30/09/2013 : In đơn nhập hàng
        /// </summary>
        public static void PrintInvoice(string invoiceCode)
        {
            try
            {
                ...
                f1.FormulaName = "CompanyName";
                f1.FormulaValue = UserImformation.CompanyName;
                listFormula.Add(f1);
                Formula f2 = new Formula();
                f2.FormulaName = "CompanyAddress";
                f2.FormulaValue = UserImformation.CompanyAdress;
                listFormula.Add(f2);
                Formula f3 = new Formula();
                f3.FormulaName = "CompanyTel";
                f3.FormulaValue = UserImformation.CompanyTelePhone;
                listFormula.Add(f3);
                Formula f4 = new Formula();
                f4.FormulaName = "CompanyFax";
                f4.FormulaValue = UserImformation.CompanyFax;
                listFormula.Add(f4);
        ...
        /// <summary>
        /// Người tạo Thanhdh – 30/09/2013 : Xóa đơn nhập hàng
        /// </summary>
        public static void DeleteInvoice(string invoiceCode)
        {
            try
            {
                ...
                MessageBox.Show(rsfImportManagement.Import2.ToString(), "Notice", MessageBoxButtons.OK,
        ...
        /// <summary>
        /// Người tạo Thanhdh – 30/09/2013 : Nhập tồn kho
        /// </summary>
        public static void InventoryImport(List<InventoryImportEntities> plist)
        {
            ...
            {
                posdb_vnmSqlDAC SqlDAC = new posdb_vnmSqlDAC();
                SqlDAC.InlineSql_ExecuteNonQuery("delete INVENTORY_TEMP", null);

                foreach (InventoryImportEntities p in plist)
                {                    
                    string invEvent = GetAutoCode("BK_EVENT_STACK_TABLE", "EVENT_ID", System.Environment.MachineName + "-" + UserImformation.DeptCode + "-" + SqlDAC.GetDateTimeServer().ToString("yy") + "-");                
        ...
        public static void ErrorImport(List<InventoryImportEntities> plist)
        {
            try
            {
                ...
                for (int i = 0; i < plist.Count; i++)
                {
                    ...
                    row["MÃ HÀNG"] = plist[i].ProductID;
                    row["SỐ LƯỢNG"] = plist[i].ProductQuantity;
                    dt.Rows.Add(row);
                }
                SaleMTCommon.Export expExcel = new SaleMTCommon.Export();
                expExcel.InfoCompany = true;
                expExcel.InfoStore = true;
                expExcel.StrTitle = "MÃ HÀNG KHÔNG THỂ IMPORT";
                expExcel.ExportToExcel(dt, "ImportError.xls");

                //CreateExcelFile.CreateExcelDocument(dt, "D:\\Sample.xlsx");
