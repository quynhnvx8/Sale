...
namespace SaleMTInterfaces.FrmSystem
{
    public partial class frmLogin : Form
    {
        ...
        private void Login()
        {
            //String decrypted = EncryptDecryptText.DecodeAndDecrypt("6xia+g3TlVnFI7LgIqXHPA==");
           // Console.WriteLine("decrypted: " + decrypted);
            ...
            string pw = txtPassword.Text.Trim() + txtUserName.Text.Trim();
            //paraLogin[1] = posdb_vnmSqlDAC.newInParam("@Pw", SaleMTEncrypt.GetMd5Hash(System.Security.Cryptography.MD5.Create(), pw));
            string hash = EncryptDecryptText.EncryptAndEncode(pw);
            paraLogin[1] = posdb_vnmSqlDAC.newInParam("@Pw", hash);
