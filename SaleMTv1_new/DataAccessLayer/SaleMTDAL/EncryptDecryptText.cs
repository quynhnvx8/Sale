...
{
    public static class EncryptDecryptText
    {
    ...
    static void Main(string[] args)
    {
        ...
        encrypted = EncryptDecryptText.EncryptAndEncode(encryptMe);
        Console.WriteLine("encypted: " + encrypted);

        decrypted = EncryptDecryptText.DecodeAndDecrypt("6xia+g3TlVnFI7LgIqXHPA==");
