...
namespace SaleMTDataAccessLayer.SaleMTDAL
{
    ...
    /// </summary>
    public class rdodb_KTSqlDAC  //StandardDAC.SqlClient.SQLDac
    {
        #region Declaration
        /// <summary>
        /// Created by Luannv – 20/09/2013: Connection string.
        /// </summary>
        private static string connection = @"Server=192.168.1.89,3241; database=rdodb_vnm; User ID=sa; Pwd=123; Connection Timeout=300;";
        #endregion
        ...
        public static void Save(object obj, string table)
        {
            try
            {
                bool isNew = true;
