...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class EXPORT_PRODUCT_STORE
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<EXPORT_PRODUCT_STORE>("EXPORT_PRODUCT_STORE");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "EXPORT_PRODUCT_STORE",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "EXPORT_PRODUCT_STORE");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<EXPORT_PRODUCT_STORE>("EXPORT_PRODUCT_STORE", posdb_vnmSqlDAC.newInParam("@EXPORT_STORE_ID", inEXPORT_STORE_ID));
        }
