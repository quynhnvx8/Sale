...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class REPORT_TEMPLATE
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<REPORT_TEMPLATE>("REPORT_TEMPLATE");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "REPORT_TEMPLATE",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "REPORT_TEMPLATE");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<REPORT_TEMPLATE>("REPORT_TEMPLATE", posdb_vnmSqlDAC.newInParam("@TEMPLATE_ID", inTEMPLATE_ID));
        }
