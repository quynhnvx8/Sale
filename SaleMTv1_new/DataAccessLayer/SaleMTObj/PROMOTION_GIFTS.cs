...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class PROMOTION_GIFTS
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<PROMOTION_GIFTS>("PROMOTION_GIFTS");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "PROMOTION_GIFTS",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "PROMOTION_GIFTS");
        }
