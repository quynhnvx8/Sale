...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class MESSAGE
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<MESSAGE>("MESSAGE");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "MESSAGE",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "MESSAGE");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<MESSAGE>("MESSAGE", posdb_vnmSqlDAC.newInParam("@MESSAGE_ID", inMESSAGE_ID));
        }
