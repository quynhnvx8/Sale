...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class COUPONS_SALES_DETAIL
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<COUPONS_SALES_DETAIL>("COUPONS_SALES_DETAIL");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "COUPONS_SALES_DETAIL",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "COUPONS_SALES_DETAIL");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<COUPONS_SALES_DETAIL>("COUPONS_SALES_DETAIL", posdb_vnmSqlDAC.newInParam("@COUPONS_SALES_DETAIL_CODE", inCOUPONS_SALES_DETAIL_CODE));
        }
