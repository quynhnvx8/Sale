...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class SALE_PROMOTION
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<SALE_PROMOTION>("SALE_PROMOTION");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "SALE_PROMOTION",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "SALE_PROMOTION");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<SALE_PROMOTION>("SALE_PROMOTION", posdb_vnmSqlDAC.newInParam("@ID", inID));
        }
