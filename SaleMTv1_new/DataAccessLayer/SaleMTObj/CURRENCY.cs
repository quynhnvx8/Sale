...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class CURRENCY
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<CURRENCY>("CURRENCY");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "CURRENCY",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "CURRENCY");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<CURRENCY>("CURRENCY", posdb_vnmSqlDAC.newInParam("@CURRENCY_ID", inCURRENCY_ID));
        }
