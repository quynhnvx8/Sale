...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class COUPONS_SALES
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<COUPONS_SALES>("COUPONS_SALES");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "COUPONS_SALES",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "COUPONS_SALES");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<COUPONS_SALES>("COUPONS_SALES", posdb_vnmSqlDAC.newInParam("@COUPONS_SALES_CODE", inCOUPONS_SALES_CODE));
        }
        /// <summary>
        ///Read by Unique Constraint
        /// </summary>
        /// <param name="inrowguid"></param>
        public static List<COUPONS_SALES> ReadByrowguid(Guid inrowguid)
        {
            return posdb_vnmSqlDAC.ReadByParams<COUPONS_SALES>("COUPONS_SALES", posdb_vnmSqlDAC.newInParam("@rowguid", inrowguid));
        }
