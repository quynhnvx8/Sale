...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class PARAMETER
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<PARAMETER>("PARAMETER");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "PARAMETER",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "PARAMETER");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<PARAMETER>("PARAMETER", posdb_vnmSqlDAC.newInParam("@PARAMETER_ID", inPARAMETER_ID));
        }
