...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class SALES_EXPORTS_ITEMS
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<SALES_EXPORTS_ITEMS>("SALES_EXPORTS_ITEMS");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "SALES_EXPORTS_ITEMS",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "SALES_EXPORTS_ITEMS");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<SALES_EXPORTS_ITEMS>("SALES_EXPORTS_ITEMS", posdb_vnmSqlDAC.newInParam("@ID", inID));
        }
