...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class CUSTOMER_CARD
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<CUSTOMER_CARD>("CUSTOMER_CARD");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "CUSTOMER_CARD",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "CUSTOMER_CARD");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<CUSTOMER_CARD>("CUSTOMER_CARD", posdb_vnmSqlDAC.newInParam("@CARD_NO", inCARD_NO));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        public static List<CUSTOMER_CARD> ReadByCUSTOMER_ID(string inCUSTOMER_ID)
        {
            ...
            return posdb_vnmSqlDAC.ReadByParams<CUSTOMER_CARD>("CUSTOMER_CARD", posdb_vnmSqlDAC.newInParam("@CUSTOMER_ID", parameter));
        }
