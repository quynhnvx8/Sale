...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class SALES_EXPORTS
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<SALES_EXPORTS>("SALES_EXPORTS");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "SALES_EXPORTS",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "SALES_EXPORTS");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<SALES_EXPORTS>("SALES_EXPORTS", posdb_vnmSqlDAC.newInParam("@EXPORT_CODE", inEXPORT_CODE));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<SALES_EXPORTS>("SALES_EXPORTS", posdb_vnmSqlDAC.newInParam("@ACCOUNT", inACCOUNT));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<SALES_EXPORTS>("SALES_EXPORTS", posdb_vnmSqlDAC.newInParam("@CURRENCY_ID", inCURRENCY_ID));
        }
