...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class VOUCHER_GIFT_TRANSFER
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<VOUCHER_GIFT_TRANSFER>("VOUCHER_GIFT_TRANSFER");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "VOUCHER_GIFT_TRANSFER",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "VOUCHER_GIFT_TRANSFER");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<VOUCHER_GIFT_TRANSFER>("VOUCHER_GIFT_TRANSFER", posdb_vnmSqlDAC.newInParam("@EXPORT_CODE", inEXPORT_CODE));
        }
