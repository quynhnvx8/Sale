...
{
    public class DEBT_APPORTION : IDataModel
    {
        #region members
        int id;
        string hOST_ID;
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<DEBT_APPORTION>("DEBT_APPORTION");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.ReadById<DEBT_APPORTION>(this, "DEBT_APPORTION");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "DEBT_APPORTION",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "DEBT_APPORTION");
        }
