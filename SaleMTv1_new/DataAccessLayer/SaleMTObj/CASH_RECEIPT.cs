...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class CASH_RECEIPT
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<CASH_RECEIPT>("CASH_RECEIPT");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "CASH_RECEIPT",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "CASH_RECEIPT");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<CASH_RECEIPT>("CASH_RECEIPT", posdb_vnmSqlDAC.newInParam("@CASH_RECEIPT_ID", inCASH_RECEIPT_ID));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        /// <param name="inTRANSFER_SHIFT_CODE"></param>
        public static List<CASH_RECEIPT> ReadByTRANSFER_SHIFT_CODE(string inTRANSFER_SHIFT_CODE)
        {
            return posdb_vnmSqlDAC.ReadByParams<CASH_RECEIPT>("CASH_RECEIPT", posdb_vnmSqlDAC.newInParam("@TRANSFER_SHIFT_CODE", inTRANSFER_SHIFT_CODE));
        }
