...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class WARRANTY_EXECUTE
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<WARRANTY_EXECUTE>("WARRANTY_EXECUTE");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "WARRANTY_EXECUTE",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "WARRANTY_EXECUTE");
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<WARRANTY_EXECUTE>("WARRANTY_EXECUTE", posdb_vnmSqlDAC.newInParam("@ID_NO_RECEIPT", inID_NO_RECEIPT));
        }
        /// <summary>
        ///Read By Foreign Key
        /// </summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<WARRANTY_EXECUTE>("WARRANTY_EXECUTE", posdb_vnmSqlDAC.newInParam("@WARRANTY_STATUS_CODE", inWARRANTY_STATUS_CODE));
        }
