...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class PRODUCTS
    {
        ...
        [SqlColumn("M_PRODUCT_ID", SqlDbType.Float)]
        public float? M_PRODUCT_ID
        {
            get { return pM_PRODUCT_ID; }
            set { pM_PRODUCT_ID = value; }
        }
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<PRODUCTS>("PRODUCTS");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "PRODUCTS",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "PRODUCTS");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<PRODUCTS>("PRODUCTS", posdb_vnmSqlDAC.newInParam("@PRODUCT_ID", inPRODUCT_ID));
        }
