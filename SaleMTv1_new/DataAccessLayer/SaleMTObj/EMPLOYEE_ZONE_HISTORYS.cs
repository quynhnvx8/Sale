...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class EMPLOYEE_ZONE_HISTORYS : IDataModel
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<EMPLOYEE_ZONE_HISTORYS>("EMPLOYEE_ZONE_HISTORYS");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.ReadById<EMPLOYEE_ZONE_HISTORYS>(this, "EMPLOYEE_ZONE_HISTORYS");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "EMPLOYEE_ZONE_HISTORYS",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "EMPLOYEE_ZONE_HISTORYS");
        }
