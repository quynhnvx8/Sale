...
namespace SaleMTDataAccessLayer.SaleMTObj
{
    public class DEV_IN_SEG_NHOMVT_PHUTHUOC
    {
        ...
        {
            return posdb_vnmSqlDAC.ReadAll<DEV_IN_SEG_NHOMVT_PHUTHUOC>("DEV_IN_SEG_NHOMVT_PHUTHUOC");
        }
        /// <summary>
        ...
        {
            posdb_vnmSqlDAC.Save(this, "DEV_IN_SEG_NHOMVT_PHUTHUOC",isNew);
        }
        /// <summary>
        ...
        public void Delete()
        {
            posdb_vnmSqlDAC.Delete(this, "DEV_IN_SEG_NHOMVT_PHUTHUOC");
        }
        /// <summary>
        ...
        {
            return posdb_vnmSqlDAC.ReadByParams<DEV_IN_SEG_NHOMVT_PHUTHUOC>("DEV_IN_SEG_NHOMVT_PHUTHUOC", posdb_vnmSqlDAC.newInParam("@TenSeg", inTenSeg));
        }
